...
function university_features() {
  ...
  add_editor_style(array('https://fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i|Roboto:100,300,400,400i,700,700i', 'dist/style-global.css', 'dist/global.css'));
}
...
function bannerBlock() {
  wp_register_script('bannerBlockScript', get_stylesheet_directory_uri() . '/dist/banner.js', array('wp-blocks', 'wp-editor'), false, true);
